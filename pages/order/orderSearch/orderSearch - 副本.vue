	...
	<view class="myOrder">
		...
		<view class="orderTop" :style="{top: `${barheight}px`}">
			<u-cell-group>
				...
				<u-cell-item :value-style="{fontSize: '24rpx'}" style="height: 80rpx;" title="订单创建时间" :value="dataRange" @click="popupShow(3)"></u-cell-item>
			</u-cell-group>
		...
		<u-popup @close="loadClose" border-radius="40" v-model="loadShow" mode="bottom" :mask-custom-style="{background: 'rgba(0, 0, 0, 0.3)'}">
			<view class="carConTit">
				<view class="carConTitBtn" @click="loadShow = false">取消</view>
		...
		<u-popup @close="unloadClose" border-radius="40" v-model="unloadShow" mode="bottom" :mask-custom-style="{background: 'rgba(0, 0, 0, 0.3)'}">
			<view class="carConTit">
				<view class="carConTitBtn" @click="unloadShow = false">取消</view>
				<view class="carConTitCon">卸货地选择</view>
				<view class="carConTitBtn" style="background: #FEC24D;" @click="unloadClear">重置</view>
			</view>
